...
namespace TriLibCore.Samples
{
    ...
    public class AssetViewer : AssetViewerBase
    {
        ...
        public string path;
        private GameObject[] ObjectsToExport;
        ...
        public async void ExportGLTF() 
        {
            // Example of gathering GameObjects to be exported (recursively)
            var rootLevelNodes = GameObject.FindGameObjectsWithTag("ToWrap");
            ...
            if (!success)
            {
               UnityEngine.Debug.LogError("Something went wrong exporting a glTF");
            }
        }
        ...
        protected override void OnLoad(AssetLoaderContext assetLoaderContext)
        {
            ...
            assetLoaderContext.RootGameObject.tag = "ToWrap";
        }
